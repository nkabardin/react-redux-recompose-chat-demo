...
const defaultTimeout = () => 3000 + Math.random() * 20000;

const doWithRandomTimeout = (action, timeoutLengthFunction = defaultTimeout) =>
  setTimeout(action, timeoutLengthFunction());
